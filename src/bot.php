...
if($this->handleTelegramRelayRequest($message, $messagetext, $inputReplyToMessage, $MadelineProto, true)){
return;
}
}else{
if($this->handleTelegramRelayRequest($message, $messagetext, $inputReplyToMessage, $this, false)){
return;
}
}
